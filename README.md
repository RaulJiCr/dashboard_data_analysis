...
Esta carpeta contiene dos entregables para convertir los dashboards existentes en material reutilizable para clase:

1. `manual_profesores.md`: guia docente para conducir el curso desde la pregunta analitica hasta el dashboard.
2. `plantilla_dashboard/`: esqueleto Streamlit documentado para que los estudiantes creen su propio dashboard con un CSV.
